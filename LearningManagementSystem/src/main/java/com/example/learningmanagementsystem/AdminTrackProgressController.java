...
public class AdminTrackProgressController implements UserAwareController {
    @FXML private Label welcomeLabel;
    @FXML private TableView<?> progressTable; // Replace ? with Progress model class
    private User user;
    ...
    public void initUserData(User user) {
        ...
        if (user != null) {
            ...
            System.err.println("⚠️ Warning: user is null in AdminTrackProgressController");
        }
    }
